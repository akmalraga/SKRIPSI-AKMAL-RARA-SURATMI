...
Fase Berry memperoleh hasil dengan mengintegralkan koneksi Berry sepanjang jalur($\bar{R}(0)$ hingga $\bar{R}(t)$). Dimana koneksi Berry dituliskan sebagai; \[ \bar{A}_n (\bar{k}) = i \langle n_k | \nabla_{\bar{R}} | n_k \rangle \]
\par
...
sehingga dengan mengikuti prosedur \parencite{} koneksi Berry diskret dapat diekstraksi sebagai
