...
\]
\par 
Dengan meninjau hubungan tensor polarisasi dan magnetisasi dan hubungannya dengan tensor medan elektromagnetk, polarisabilitas magnetoelectric akhirnya dapat dirumuskan sebagi\parencite{PhysRevLett.58.1799}.
\[
...
Untuk membawa persamaan ini ke dalam perhitungan numerik, \parencite{PhysRevLett.102.146805} mempertimbangkan masalah \textit{gauge-fixing} yang dapat mempengaruhi akurasi perhitungan, seperti yang disingguns pada \ref{subsec:HWF}. Untuk itu dengan melakukan modifikasi yang meninjau polarisasi pada penelitian \parencite{Vanderbilt2018}, \parencite{PhysRevLett.102.146805} melakukan prosedur transisi dengan memvariasikan parameter magnetik $\beta$ secara perlahan, sehingga $\theta$ dapat dihitung sebagai integrasi terhadap $\beta$. $\theta(\beta)$ dihitung untuk ekspresi \textit{second chern number} menggunakan \textit{Four Curvature Formulation}
\[
