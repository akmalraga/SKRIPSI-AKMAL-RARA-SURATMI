...
\begin{figure}[h]
  \centering 
\includegraphics[width=0.7\linewidth]{picture/band-gap.png}
\caption{Struktur pita energi pada material isolator, semikonduktor, dan konduktor.}
  \label{fig:band-gap}
\end{figure}
...
\begin{figure}[h]
  ...
  \caption{Fenomena konduktansi tepi pada efek hall kuantum.}
  \label{fig:qhall-effect}
\end{figure}
...
\begin{figure}[h]
  ...
  \caption{Model Haldane dengan hopping yang menunjukkan fenomena topologi.}
  \label{fig:haldane_hoppings}
\end{figure}
...
\begin{figure}[h]
  \centering 
  \includegraphics[width=0.7\linewidth]{picture/qsh_hallbar.png}
  \caption{Aplikasi model kane mele untuk pemisahan spin up dan down untuk transistor spintronik.}
  \label{fig:qsh-hallbar}
\end{figure}
